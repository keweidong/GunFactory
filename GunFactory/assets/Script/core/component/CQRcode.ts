...
// @ccclass
// @menu("UI/CQRCode")
// export class CQRCode extends cc.Graphics {
//     @property()
//     protected _string = "Hello World!";
//     @property()
//     protected set string(old) {
//         if (this.string === old) {
//             return;
//         }
//         this._string = old;
//         this.setContent();
//     }
//     protected get string() { return this._string; }
...
//         type: cc.color
//     })
//     protected set backColor(old) {
//         this._backColor = old;
//         this.setContent();
//     }
//     protected get backColor() { return this._backColor; }
...
//         type: cc.color
//     })
//     protected set foreColor(old) {
//         this.node.color = this.foreColor;
//         this._foreColor = old;
//         this.setContent();
//     }
//     protected get foreColor() { return this._foreColor; }

//     @property()
//     protected _margin = 10;
//     @property()
//     protected set margin(old) {
//         if (old === this._margin) {
//             return;
//         }
//         this._margin = old;
//         this.setContent();
//     }
//     protected get margin() { return this._margin; }
//     @property()
//     protected _size = 200;
//     @property()
...
//         this._size = value;
//     }
//     protected get size() { return this._size; }
//     onLoad() {
