...
function color(colorStr: string) {
    return cc.color(
...
var DEFAULT_SETTINGS = {
    ...
    // COLORS
    background_color: color('#171717'),
    selection_color: color('#4BB2FD'),
    block_border_color: color('#6D6D6D'),
    block_symbol_color: color('#333333'),
    anchor_background_color: color('#EFEFEF'),

    connection_color: color('#6D6D6D'),
    root_color: color('#FFFFFF'),
    decorator_color: color('#FFFFFF'),
    composite_color: color('#FFFFFF'),
    tree_color: color('#FFFFFF'),
    action_color: color('#FFFFFF'),
    condition_color: color('#FFFFFF'),
