...
declare namespace qq {
    ...
    interface Canvas {
        ...
        /**画布的高度 */
        height: number;
        getContext(contextType: string, contextAttributes?: contextAttributes): any
    }
    ...
    function onShareMessageToFriend(callback: (success, errMsg) => void)
    ...
    // getFriendCloudStorage(object: { keyList: UserGameData[], success: (res: UserGameData) => void, fail: (res: any) => void, complete: (res: any) => void }): void;

    function shareMessageToFriend(object: shareToFriendParam): void;
    /**
     ...
     */
    function getUserCloudStorage(Object: object);
    function setUserCloudStorage(Object: object);
    /**
     * 主动拉起转发，进入选择通讯录界面
     * @param {object} 入参对象
