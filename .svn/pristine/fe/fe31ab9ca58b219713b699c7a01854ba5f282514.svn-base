...
namespace CoreDecorators {
    ...
    export function profile(params: string);
    export function profile(params: string, param1: number);
    export function profile(params: string, param1: Function);
}